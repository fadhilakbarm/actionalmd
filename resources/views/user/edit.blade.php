...
@section('content')
    <div class="container">
        <div class="card">
            <div class="card-body">
                {!! Form::model($data, ['route' => ['user.update', $data->id], 'class' => 'form', 'method' => 'PUT']) !!}
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        {!! Form::select('gender', ['male' => 'Male', 'female' => 'Female'], null, ['class'=>'form-control select2']) !!}
                    </div>
                    ...
                    <div class="form-group mb-3 col-lg-3">
                        ...
                        <div class="col-lg-12">
                            <div class="input-group date">
                                {!! Form::text('joined_date', null, ['class'=>'form-control datepicker']) !!}
